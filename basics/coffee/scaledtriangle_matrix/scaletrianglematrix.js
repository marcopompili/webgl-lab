(function() {
  var FSHADER_SOURCE, Sx, Sy, Sz, Tw, Tx, Ty, Tz, VSHADER_SOURCE, canvas, compileProgram, compileShader, gl, initVertexBuffers, n, program, u_xformMatrix, xformMatrix;
  ...
  xformMatrix = new Float32Array([Sx, 0.0, 0.0, 0.0, 0.0, Sy, 0.0, 0.0, 0.0, 0.0, Sz, 0.0, Tx, Ty, Tz, Tw]);
