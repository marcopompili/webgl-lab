(function() {
  var ANGLE, FSHADER_SOURCE, VSHADER_SOURCE, canvas, compileProgram, compileShader, gl, initVertexBuffers, modelMatrix, n, program, u_ModelMatrix;
  ...
  modelMatrix.setRotate(ANGLE, 0, 0, 1.0);
